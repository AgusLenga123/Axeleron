                    ...
                    <div>
                        ...
                        <div>
                            <a
                                id="solution-cta"
                                href="#contacto"
                                className={cn(buttonVariants({ variant: "premium", size: "lg" }), "group h-12 px-7 rounded-xl font-bold")}
                            >
                                Empezar ahora
                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="bg-background/50 rounded-2xl p-5 border border-white/5">
                                    ...
                                    <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                                        <div className="h-full bg-gradient-to-r from-primary to-accent rounded-full" style={{ width: "76%" }} />
                                    </div>
