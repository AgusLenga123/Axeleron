                ...
                <div className="max-w-4xl mx-auto">
                    <div className="relative rounded-3xl border border-primary/20 bg-background/60 backdrop-blur-sm overflow-hidden p-10 md:p-16">
                        ...
                        <div className="relative text-center">
                            ...
                            <p className="text-primary font-semibold text-sm uppercase tracking-widest mb-4">Nuestra garantía</p>
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-12 text-left">
                                {[
                                    ...
                                    <div key={i} className="bg-secondary/30 border border-border/40 rounded-2xl p-5">
                            ...
                            <a
                                id="guarantee-cta"
                                href="#contacto"
                                className={cn(buttonVariants({ variant: "premium", size: "lg" }), "h-14 px-10 rounded-xl font-bold text-base")}
                            >
