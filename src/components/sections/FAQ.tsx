...
const faqs = [
    ...
    { q: "¿Qué información necesitan de mi parte?", a: "Solo necesitamos que nos cuentes sobre tu negocio en una llamada de 30 minutos. Si tenés logo y colores de marca, perfecto. Si no tenés nada, trabajamos igualmente. El copy (texto) lo escribimos nosotros si elegís el plan Pro o Business." },
